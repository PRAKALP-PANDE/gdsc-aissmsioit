    ...
    <div className="blog-container">
      ...
      >
        ...
        <div className="card_main">
          ...
          <div className="card__footer">
            <div className="user">
              <a target="_blank" rel="noreferrer" href="https://gdsc.community.dev/u/m8vetm/">
                <img
      ...
      >
        ...
        <div className="card_main">
          ...
          <div className="card__footer">
            <div className="user">
              <a target="_blank" rel="noreferrer" href="https://gdsc.community.dev/u/mw4r7j/">
                <img
                  src="https://i.pravatar.cc/40?img=68"
                  alt="user__image"
                  className="user__image"
      ...
      >
        ...
        <div className="card_main">
          ...
          <div className="card__footer">
            <div className="user">
              <a target="_blank" rel="noreferrer" href="https://i.pravatar.cc/40?img=68">
                <img
                  src="https://i.pravatar.cc/40?img=68"
                  alt="user__image"
                  className="user__image"
